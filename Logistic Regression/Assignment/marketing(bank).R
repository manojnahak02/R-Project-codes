marketing<-read.csv(file="E:\\Imarticus DSP 24\\R Programs\\Logistic Regression\\Assignment\\Marketing Dataset.csv")
View(marketing)
summary(marketing)
str(marketing)
...
#
#testing$predict<-as.factor(ifelse(testing$probs>0.40,1,0))
t#able(testing$deposit,testing$predict)
#
#(1375+1308)/(1375+386+278+1308)
#confuxion matrix
library(caret)
confusionMatrix(testing$deposit,testing$predict)
